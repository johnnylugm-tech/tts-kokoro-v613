...
| FR-09 | kokoro_client | `03-development/src/backend/kokoro_client.py` | `tests/test_fr09_kokoro_client.py` | `pytest tests/test_fr09*.py -v` |
...
# 或修復特定步驟：
python3 cli.py plan-phase --phase 6 --repair --step 6.2 --goal "Phase 6 execution for tts-kokoro-v613"
