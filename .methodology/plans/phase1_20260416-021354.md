...
python3 cli.py run-phase --phase 1 --goal "SRS.md, SPEC_TRACKING.md, TRACEABILITY_MATRIX.md"
```
...
**SRS §FR-01 要求**：
> 詳見 `.methodology/plans/phase1_FULL.md` 或執行 `python3 scripts/generate_full_plan.py --phase 1`
...
# 或修復特定步驟：
python3 cli.py plan-phase --phase 1 --repair --step 1.2 --goal "SRS.md, SPEC_TRACKING.md, TRACEABILITY_MATRIX.md"
