...
python3 cli.py run-phase --phase 2 --goal "SAD.md, ADR"
```
...
**SRS §FR-01 要求**：
> 詳見 `.methodology/plans/phase2_FULL.md` 或執行 `python3 scripts/generate_full_plan.py --phase 2`
...
# 或修復特定步驟：
python3 cli.py plan-phase --phase 2 --repair --step 2.2 --goal "SAD.md, ADR"
