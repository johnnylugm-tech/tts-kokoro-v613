...
python3 cli.py run-phase --phase 5 --goal "BASELINE.md, MONITORING_PLAN.md"
```
...
**SRS §FR-01 要求**：
> 詳見 `.methodology/plans/phase5_FULL.md` 或執行 `python3 scripts/generate_full_plan.py --phase 5`
...
# 或修復特定步驟：
python3 cli.py plan-phase --phase 5 --repair --step 5.2 --goal "BASELINE.md, MONITORING_PLAN.md"
