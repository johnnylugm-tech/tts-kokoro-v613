...
python3 cli.py run-phase --phase 7 --goal "RISK_REGISTER.md"
```
...
**SRS §FR-01 要求**：
> 詳見 `.methodology/plans/phase7_FULL.md` 或執行 `python3 scripts/generate_full_plan.py --phase 7`
...
# 或修復特定步驟：
python3 cli.py plan-phase --phase 7 --repair --step 7.2 --goal "RISK_REGISTER.md"
