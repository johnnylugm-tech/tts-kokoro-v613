...
python3 cli.py run-phase --phase 4 --goal "TEST_PLAN.md, TEST_RESULTS.md"
```
...
**SRS §FR-01 要求**：
> 詳見 `.methodology/plans/phase4_FULL.md` 或執行 `python3 scripts/generate_full_plan.py --phase 4`
...
# 或修復特定步驟：
python3 cli.py plan-phase --phase 4 --repair --step 4.2 --goal "TEST_PLAN.md, TEST_RESULTS.md"
