...
python3 cli.py run-phase --phase 8 --goal "CONFIG_RECORDS.md, Git Tag"
```
...
**SRS §FR-01 要求**：
> 詳見 `.methodology/plans/phase8_FULL.md` 或執行 `python3 scripts/generate_full_plan.py --phase 8`
...
# 或修復特定步驟：
python3 cli.py plan-phase --phase 8 --repair --step 8.2 --goal "CONFIG_RECORDS.md, Git Tag"
