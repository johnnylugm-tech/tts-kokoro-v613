...
class CircuitBreaker:
    ...
    async def call_async(self, coro: Awaitable[Any], *args: Any, **kwargs: Any) -> Any:
        """
    ...
    def _closed_call(self, func: Callable[..., Any], *args: Any, **kwargs: Any) -> Any:
        """CLOSED 狀態的執行包裝。"""
        try:
    ...
    async def _closed_call_async(
        self, coro: Awaitable[Any], *args: Any, **kwargs: Any
    ) -> Any:
    ...
    def _half_open_call(self, func: Callable[..., Any], *args: Any, **kwargs: Any) -> Any:
        """HALF_OPEN 狀態的單次試探執行。"""
        try:
            result = func(*args, **kwargs)
            self.record_success()
